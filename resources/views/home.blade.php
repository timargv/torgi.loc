            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        {{--<a class="float-right btn btn-primary btn-sm" data-toggle="collapse" href="#collapseExample2" role="button" aria-expanded="false" aria-controls="collapseExample2">--}}
                            {{--<i class="fa fa-plus" aria-hidden="true"></i>--}}
                        {{--</a>--}}
                        {{--<form class="form-inline mr-3 float-right col-3">--}}
                            {{--<div class="form-row align-items-center  w-100">--}}
                                {{--<div class=" w-100">--}}
                                    {{--<div class="input-group">--}}
                                        {{--<input type="text" name="name" class="form-control mb-2 form-control-sm mr-0 rounded-left" id="inlineFormInput" placeholder="Найти">--}}
                                    {{--</div>--}}
                                {{--</div>--}}
                            {{--</div>--}}
                        {{--</form>--}}
                    </div>
                    <div class="collapse bg-light border-left-0 border-right-0 border-top-0 rounded-0 " id="collapseExample2">
                        <form method="POST" action="{{ route('admin.products.store') }}" class="form-inline float-right mx-3">
                            @csrf
